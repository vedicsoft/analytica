...
var Layout = function () {
    ...
    var handleSidebarToggler = function () {
        ...
        $('body').on('click', '.sidebar-toggler', function (e) {
            ...
            var pageSliderHeading = $('.page-slider-heading');
            ...
            if (body.hasClass("page-sidebar-closed")) {
                ...
                pageSliderHeading.removeClass("page-slider-heading-closed");
                if ($.cookie) {
                ...
                pageSliderHeading.addClass("page-slider-heading-closed");
                if (body.hasClass("page-sidebar-fixed")) {
